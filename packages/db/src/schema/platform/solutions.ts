...
import { boolean, real, text } from 'drizzle-orm/pg-core'
import { createInsertSchema, createSelectSchema } from 'drizzle-zod'
import { xSolutionPsychologyConcepts } from './x-solution-psychology-concepts'

export const easeOfUseEnum = platformSchema.enum('ease_of_use', easeOfUse)

export const solutions = platformSchema.table('solutions', {
  id: unsafeId,
