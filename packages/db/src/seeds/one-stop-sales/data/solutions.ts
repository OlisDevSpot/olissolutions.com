...
export const solutionsData = {
  ...
  electricals: [
    {
      ...
      accessor: "mpu",
      description: "Main Panel Upgrade to 200A",
  ...
  flooring: [],
  adu: [],
} as const satisfies Partial<Record<UpgradeAccessor, Omit<InsertSolution, "upgradeId">[]>>;
