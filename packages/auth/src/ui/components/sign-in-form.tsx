...
import type { LoginFormSchema } from '@workspace/auth/schemas'
import { zodResolver } from '@hookform/resolvers/zod'
import { signIn } from '@workspace/auth/client'
import { loginFormSchema } from '@workspace/auth/schemas'
    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground text-balance">
                    Login to your Olis Solutions account
                  </p>
                </div>
                <FormField
          ...
          <div className="bg-muted relative hidden md:block border-4 border-red-500">
            <img
