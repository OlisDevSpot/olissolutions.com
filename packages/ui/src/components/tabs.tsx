...
function TabsTrigger({
  ...
  minimalCSS = false,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.Trigger> & { minimalCSS?: boolean }) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        minimalCSS ? '' : 'data-[state=active]:bg-background dark:data-[state=active]:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30 ',
        className,
      )}
      {...props}
    />
