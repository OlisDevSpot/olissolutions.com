...
import { createTRPCRouter, protectedProcedure, publicProcedure } from '@olis/trpc/init'
...
export const tradesRouter = createTRPCRouter({
  ...
  updateOne: protectedProcedure
    .input(z.object({ id: z.number(), ...insertTradeSchema.strict().partial().shape }))
    .mutation(async ({ input }) => {
