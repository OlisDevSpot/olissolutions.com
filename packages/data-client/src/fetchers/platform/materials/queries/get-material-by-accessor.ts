...
export type Request = InferRequestType<typeof honoClient.api['platform']['materials'][':accessor']['$get']>
export type Response = InferResponseType<typeof honoClient.api['platform']['materials'][':accessor']['$get'], 200>
...
export function getMaterialByAccessorQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const res = await honoClient.api.platform.materials[':accessor'].$get({ param: {
