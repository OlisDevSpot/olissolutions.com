...
export type Request = InferRequestType<typeof honoClient.api['platform']['materials']['$get']>
export type Response = InferResponseType<typeof honoClient.api['platform']['materials']['$get'], 200>
...
export function getMaterialsQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const res = await honoClient.api.platform.materials.$get()
