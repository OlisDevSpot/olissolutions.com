...
export type Request = InferRequestType<typeof honoClient.api['platform']['addons'][':accessor']['$get']>
export type Response = InferResponseType<typeof honoClient.api['platform']['addons'][':accessor']['$get'], 200>
...
export function getAddonByAccessorQueryOptions(
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const res = await honoClient.api.platform.addons[':accessor'].$get({ param: {
